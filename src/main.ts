...
import { DateSuggest, TagSuggest, TimeSuggest, PrioritySuggest, AssigneeSuggest } from './components/Editor/suggest';
...
export default class KanbanPlugin extends Plugin {
  ...
  async onload() {
    ...
    this.registerEditorSuggest(new PrioritySuggest(this.app, this));
    this.registerEditorSuggest(new AssigneeSuggest(this.app, this));
